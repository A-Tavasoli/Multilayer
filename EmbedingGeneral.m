...
%% Optimization input
c=10^1;         %total budget
n=30;           %number of nodes in graph 1
m=30;           %number of nodes in graph 2
K=3;            %number of interconnection at each node
nc=n*K;          %total number of interlinks
N=n+m; 
nm=n*m; 
B0=zeros(n,m); 
I=eye(N,N);
...
%% 
load('B0RandK2');
% Nodes1=randi([1,n],nc,1);  
% Nodes2=randi([1,m],nc,1);
% Links=[Nodes1 Nodes2];
% for i=1:nc-1
%     for j=i+1:nc
