...
%Optimization input
c=50; n=30; m=15;
load('A1WSCase1'); load('A2WSCase1'); n=max(size(A1)); m=max(size(A2)); N=n+m; nm=n*m; B0=ones(n,m); I=eye(N,N);
...
%% BA Layers
% n1=9; seed1 = rand(n1,n1) < 1; seed1 = triu(seed1,1); seed1 = seed1 + seed1';
% n2=2; seed2 = rand(n2,n2) < 1; seed2 = triu(seed2,1); seed2 = seed2 + seed2';
% mlink1=3; mlink2=1; A1 = SFNG(n, mlink1, seed1); A2 = SFNG(m, mlink2, seed2);
...
% [e1(2)/n e2(2)/m]
%% Combined layers
% r1=1*sqrt(2*log(n)/n); A1=NetGen_Geo(n,r1);   G1 = graph(A1); L0_1=laplacian(G1);
