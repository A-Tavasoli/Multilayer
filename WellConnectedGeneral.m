clc;clear
%Optimization input
n=10; m=5; N=n+m; nm=n*m;  cf=15; mc=n*m; q=cf/mc; %mc number of intrlinks
B0=ones(n,m);
...
%% ER layers
% p1=.3; p2=.5; G1=ErdosRenyi(n,p1); G2=ErdosRenyi(m,p2); 
...
% A1=adjacency(G1); A2=adjacency(G2); 
%% Combined layers
% r2=.8*sqrt(2*log(m)/m); A2=NetGen_Geo(n,r2); G2 = graph(A2); L0_2=laplacian(G2); 
% K1=1; beta1=0; G1 = WattsStrogatz(n,K1,beta1); L0_1=laplacian(G1); A1=adjacency(G1);  
% G1=WheelGraph(n); L0_1=laplacian(G1); A1=adjacency(G1);
% G1=MeshGraph3(n); L0_1=laplacian(G1); A1=adjacency(G1);
